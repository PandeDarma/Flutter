<html lang="en"><head>
	...
	<link href="<?php echo e(asset('assets/vendor/linearicons/style.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/vendor/chartist/css/chartist-custom.css')); ?>" rel="stylesheet">
	<!-- MAIN CSS -->
...
<body>
	...
	<div id="wrapper">
			...
			<div class="slimScrollDiv" style="width: auto; height: 95%; overflow: hidden; position: relative;"><div class="sidebar-scroll" style="width: auto; height: 95%; overflow: hidden;">
				<nav>
					<ul class="nav">
						...
						<li><a class="active" href="charts.html"><i class="lnr lnr-chart-bars"></i> <span>Charts</span></a></li>
		...
		<div class="main" style="min-height: 575px;">
			...
			<p style="font-size : 100px">MAIKUM~~~~~~~</p>
			<!-- END MAIN CONTENT -->
		</div>
		<!-- END MAIN -->
...
</body></html><?php /**PATH F:\Filenya Pande\blog\resources\views/LayOut/Awal.blade.php ENDPATH**/ ?>